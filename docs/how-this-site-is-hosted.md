...
## Hosting
Vercel is linked to the site's GitHub repo (which needs to be public). Every time a commit is pushed, it is automatically detected and the live site updates. Domains can be bought and applied through Vercel directly.